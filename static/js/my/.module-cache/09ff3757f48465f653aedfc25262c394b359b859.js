define(['jquery','react', 'bootstrap', 'mixins'], function($, React, bootstrap, mixins){
	var 
		...
		Modal = React.createClass({displayName: "Modal",
			...
			render: function() {
				//onTouchStart={this.handleTouch.bind(this, button.handler)}
				var buttons = this.props.buttons.map(function(button) {
					return React.createElement("button", {type: "button", className: "btn btn-" + button.type, onClick: this.handleClick.bind(this, button.handler)}, button.text)
				}.bind(this))
