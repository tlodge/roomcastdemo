 		...
 		Question = React.createClass({displayName: "Question",
 			render: function() {
 				...
 				var components = this.props.components.map(function(component,i){
 					return React.createElement(Component, {column: i, top: this.props.top+headingheight, height: this.props.height-headingheight, width: Math.ceil(this.props.width/this.props.components.length), left: i*this.props.width/this.props.components.length, data: component})
 				}.bind(this));
