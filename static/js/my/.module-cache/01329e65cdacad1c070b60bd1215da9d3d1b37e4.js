	...
	var ButtonList = React.createClass({displayName: "ButtonList",
		...
		render: function(){
			...
			var columns = this.props.buttons.map(function(item, i){
				...
				return (
					 React.createElement(ButtonColumn, {colours: this.props.colours, clickhandler: this.handleModalClick, column: i, left: left, buttonwidth: this.props.buttonwidth, buttonheight: this.props.buttonheight, category: item.category, buttons: item.buttons})
				);
			}.bind(this));
	...
	var ButtonColumn = React.createClass({displayName: "ButtonColumn",
		...
		render: function(){
			...
			var column = this.props.buttons.map(function(item, i){
				...
				console.log(i * this.props.column);
