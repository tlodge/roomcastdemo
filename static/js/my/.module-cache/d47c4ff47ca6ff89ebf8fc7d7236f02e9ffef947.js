define(['jquery','react', 'mixins', 'modal'], function($, React, mixins, modal){
	...
	var MainPanel = React.createClass({displayName: "MainPanel",
		...
		render: function(){
			var colours = ["#7bb6a4","#e5cf58","#cd804a","#445662","#d35a51", "#3f3b3cf"];
		...
		render: function(){
			...
			return(	
				React.createElement("div", null, 
					...
					React.createElement(modal.Modal, {ref: "modal", modalwidth: this.props.windowwidth*0.9, modalheight: this.props.windowheight*0.6, show: false, header: this.state.currentbutton.name, buttons: buttons}, 
	...
	var init = function(){
		...
		React.render(
			React.createElement(MainPanel, {url: "buttons/buttonlibrary.json"}), document.getElementById('panel')
		)
