		...
		render: function(){
			...
			return (
				React.createElement("div", {className: "buttonpanel"}, 
					React.createElement(ButtonList, {colours: colours, buttons: this.state.buttons, buttonwidth: this.state.buttonwidth, windowheight: this.state.windowheight, windowwidth: this.state.windowwidth})
				)
			)
		}
	});
