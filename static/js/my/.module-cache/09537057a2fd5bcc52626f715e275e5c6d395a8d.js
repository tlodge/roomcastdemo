	...
	var 
		...
		Modal = React.createClass({displayName: "Modal",
			...
			event: function(item){
				...
				console.log(item.nativeEvent.pre);	
			},
			
			render: function() {
				// onTouchStart={this.handleTouch(button.handler)} 
				var buttons = this.props.buttons.map(function(button) {
					return React.createElement("button", {type: "button", className: "btn btn-" + button.type, onTouchStart: this.handleTouch.bind(this,button.handler)}, button.text)
				}.bind(this))
