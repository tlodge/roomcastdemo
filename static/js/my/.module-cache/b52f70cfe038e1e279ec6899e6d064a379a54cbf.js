	...
	var ButtonList = React.createClass({displayName: "ButtonList",
		...
		render: function(){
			...
			var columns = this.props.buttons.map(function(item, i){
				...
				return (
					 React.createElement(ButtonColumn, {buttoncount: buttoncount-item.buttons.length, colours: this.props.colours, clickhandler: this.handleModalClick, column: i, left: left, buttonwidth: this.props.buttonwidth, buttonheight: this.props.windowheight / 5, category: item.category, buttons: item.buttons})
				);
