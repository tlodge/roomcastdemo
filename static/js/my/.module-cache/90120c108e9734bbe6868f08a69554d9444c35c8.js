		...
		ModalAbout = React.createClass({displayName: "ModalAbout",
 		...
 		Component = React.createClass({displayName: "Component",
 			...
 			render: function(){
 				...
 				switch (this.props.component.type){
 					case "text":
 						formitem = React.createElement(TextInput, {width: this.props.width, height: this.props.height, value: this.props.component.value, handleUpdate: this.handleUpdate})
 						break;
 					case "options":
 		...
 		TextInput = React.createClass({displayName: "TextInput",
 			...
 			handleChange:function(event){
 				...
 				this.props.handleUpdate({name:event.target.value, value:event.target.value});
 			},
