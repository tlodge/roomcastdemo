						...
						React.createElement("div", {className: "modal-dialog", style: modalStyle}, 
							React.createElement("div", {className: "modal-content"}, 
								...
								React.createElement("div", {className: "modal-body", style: bodyStyle}, 
										...
										React.createElement(ModalOptions, {id: this.props.button.id, options: this.props.button.options || [], height: this.props.modalheight, left: Math.floor(this.props.modalwidth*1/4), width: Math.floor(this.props.modalwidth*3/4)-1})
		...
		ModalAbout = React.createClass({displayName: "ModalAbout",
 		...
 		ModalOptions = React.createClass({displayName: "ModalOptions",
 			...
 			handleUpdate: function(item){
 				console.log("button" + this.props.id);
 				console.log(item);
 			},
 		...
 		Question = React.createClass({displayName: "Question",
 			...
 			handleUpdate: function(item){
 				console.log("question---" + this.props.id + "-----");
 				console.log(item.questionid=this.props.id);
 		...
 		Component = React.createClass({displayName: "Component",
 			...
 			handleUpdate: function(item){
 				console.log("component " + this.props.id + " seen an update!");
