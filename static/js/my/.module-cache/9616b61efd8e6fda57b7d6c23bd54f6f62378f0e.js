		...
		render: function(){
			...
			return(	
				React.createElement("div", null, 
					...
					React.createElement(modal.Modal, {ref: "modal", button: this.state.currentbutton, modalwidth: this.props.windowwidth*0.9, modalheight: this.props.windowheight*0.8, show: false, header: this.state.currentbutton.name, buttons: buttons})
				)
			)
