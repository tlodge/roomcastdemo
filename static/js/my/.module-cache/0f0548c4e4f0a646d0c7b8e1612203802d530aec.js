define(['jquery','react', 'mixins', 'modal'], function($, React, mixins, modal){
	...
	var Button = React.createClass({displayName: "Button",
		...
		render: function(){
			...
			return(
				React.createElement("div", null, 
					React.createElement("div", {className: "button", style: textStyle, onTouchStart: this.handleTouch, onClick: this.handleClick, style: this.props.buttonstyle}, this.props.data.name, " ")
				)
			)
		}
	});
