		...
		ModalAbout = React.createClass({displayName: "ModalAbout",
 		...
 		Component = React.createClass({displayName: "Component",
 			...
 			render: function(){
 				...
 				switch (this.props.component.type){
 					case "options":
 						formitem = React.createElement(DropDown, {height: this.props.height, options: this.props.component.options || []})
 						break;
 					default:
 						break;
 				}
 		...
 		DropDown = React.createClass({displayName: "DropDown",
 			...
 			render:function(){
 				...
 				return React.createElement("select", {className: "form-control"}, options)
 			}
 		});
