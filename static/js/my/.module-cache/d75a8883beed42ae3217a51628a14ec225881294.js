 		...
 		ModalOptions = React.createClass({displayName: "ModalOptions",
			...
			render: function() {
				...
				var questions = this.props.options.map(function(option, i){
					return(
						React.createElement(Question, {top: i*this.props.height/this.props.options.length, height: this.props.height/this.props.options.length, width: this.props.height, question: option.question, components: option.components || []})
					)
				}.bind(this));
 		...
 		Question = React.createClass({displayName: "Question",
 			render: function() {
 				...
 				var components = this.props.components.map(function(component,i){
 					return React.createElement(Component, {top: this.props.top, height: this.props.height, width: this.props.width/this.props.components.length, left: i*this.props.width/this.props.components.length, data: component})
 				}.bind(this));
