define(['jquery','react'], function($, React){
	...
	var Button = React.createClass({displayName: "Button",
		...
		render: function(){
			return(
				React.createElement("div", {className: "button", onTouch: this.handleClick, onClick: this.handleClick, style: this.props.buttonstyle}, this.props.data.name, " ")
			)
		}
	});
	...
	var init = function(){
		...
		React.initialiseTouchEvents(true);
