		...
		render: function(){
			...
			return(	
				React.createElement("div", null, 
					...
					React.createElement(modal.Modal, {ref: "modal", modalwidth: this.props.windowwidth*0.8, modalheight: this.props.windowheight*0.6, show: false, header: this.state.currentbutton.name, buttons: buttons}, 
