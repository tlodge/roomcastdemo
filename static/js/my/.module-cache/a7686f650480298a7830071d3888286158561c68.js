		...
		Modal = React.createClass({displayName: "Modal",
			...
			render: function() {
				...
				var buttons = this.props.buttons.map(function(button) {
					return React.createElement("button", {type: "button", className: "btn btn-" + button.type, onClick: self.handleClick.bind(this,button.handler), onTouchStart: self.handleTouch.bind(this,button.handler)}, button.text)
				})
