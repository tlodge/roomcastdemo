	...
	var 
		...
		ModalAbout = React.createClass({displayName: "ModalAbout",
 		...
 		TextInput = React.createClass({displayName: "TextInput",
 			...
 			render:function(){
 				console.log("AM IN TEXT RENDERR!");
 				...
 				return React.createElement("input", {type: "text", style: myStyle, value: this.props.value, className: "form-control", onChange: this.handleChange}, options)	
 			}
