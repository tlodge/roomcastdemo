	...
	var 
		...
		ModalAbout = React.createClass({displayName: "ModalAbout",
 			...
 			render:function(){
 				...
 				var options = this.props.options.map(function(option, i){
 					...
 					var radioStyle={
 						...
 						background: this.props.state.selected==option? 'red':'white',
 					}
 					
 					return React.createElement(Radio, {radioStyle: radioStyle, handleSelect: this.handleSelect})
 				}.bind(this));
 		...
 		Radio = React.createClass({displayName: "Radio",
 			...
 			render:function(){
 				return	React.createElement("div", {style: this.props.radioStyle})
 			}
