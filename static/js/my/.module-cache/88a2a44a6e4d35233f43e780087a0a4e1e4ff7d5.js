 		...
 		ModalOptions = React.createClass({displayName: "ModalOptions",
			...
			render: function() {
				...
				var questions = this.props.options.map(function(option, i){
					return(
						React.createElement(Question, {top: i*this.props.height/this.props.options.length, height: Math.ceil(this.props.height/this.props.options.length), width: this.props.width, question: option.question, id: option.id, components: option.components || []})
					)
				}.bind(this));
