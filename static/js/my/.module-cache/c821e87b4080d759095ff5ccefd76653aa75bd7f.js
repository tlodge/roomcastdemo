 		...
 		Question = React.createClass({displayName: "Question",
 			render: function() {
 				...
 				var components = this.props.components.map(function(component,i){
 					return React.createElement(Component, {column: i, top: this.props.top+headingheight, height: this.props.height-headingheight, width: this.props.width/this.props.components.length, left: i*this.props.width/this.props.components.length, data: component})
 				}.bind(this));
 		...
 		Component = React.createClass({displayName: "Component",
 			...
 			render: function(){
 				...
 				myStyle={
 					...
 					height: this.props.height,
 					position:'absolute',
 					background: this.props.column % 2 == 0 ? '#ececec' : '#cccccc',
 				}
