	...
	var 
		...
		ModalAbout = React.createClass({displayName: "ModalAbout",
 			...
 			render: function(){
 				...
 				switch (this.props.component.type){
 					case "options":
 						...
 						break;
 					case "checkbox":
 						formitem = React.createElement(CheckBox, {width: this.props.width, height: this.props.height, text: this.props.component.text, value: this.props.component.value, id: this.props.component.id, selected: this.props.selected})
 		...
 		CheckBox = React.createClass({displayName: "CheckBox",
			...
			event: function(e){
				console.log("seen a click/rtouch event!");
			},
 			...
 			render:function(){
 				...
 				myStyle={
 					...
 					borderColor: '#4d4d4d',
 					borderStyle: 'solid',
 					background: this.props.selected ? 'red':'white',
 					left: left,
 				...
 				return 	React.createElement("div", {style: myContainer}, 
 							React.createElement("div", {style: myStyle, id: this.props.id, value: this.props.value, onTouchStart: this.handleClick, onClick: this.handleTouch}), 
