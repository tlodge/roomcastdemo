 		...
 		Question = React.createClass({displayName: "Question",
 			render: function() {
 				...
 				var components = this.props.components.map(function(component,i){
 					return React.createElement(Component, {top: this.props.top, height: this.props.height, width: this.props.width, left: i*this.props.width/this.props.components.length, data: component})
 				}.bind(this));
