		...
		Modal = React.createClass({displayName: "Modal",
			...
			mixins: [modalmixin], 
 			...
 			handleUpdate: function(item){
 				...
 				console.log("seen a handle update");
 				console.log(item);
 			},
						...
						React.createElement("div", {className: "modal-dialog", style: modalStyle}, 
							React.createElement("div", {className: "modal-content"}, 
								...
								React.createElement("div", {className: "modal-body", style: bodyStyle}, 
										...
										React.createElement(ModalOptions, {handleUpdate: this.handleUpdate, id: this.props.button.id, options: this.props.button.options || [], height: this.props.modalheight, left: Math.floor(this.props.modalwidth*1/4), width: Math.floor(this.props.modalwidth*3/4)-1})
 		...
 		ModalOptions = React.createClass({displayName: "ModalOptions",
			...
			render: function() {
				...
				var questions = this.props.options.map(function(option, i){
					return(
						React.createElement(Question, {handleUpdate: this.props.handleUpdate, top: i*this.props.height/this.props.options.length, height: Math.ceil(this.props.height/this.props.options.length), width: this.props.width, question: option.question, id: option.id, components: option.components || []})
					)
				}.bind(this));
