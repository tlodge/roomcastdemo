		...
		ModalAbout = React.createClass({displayName: "ModalAbout",
 		...
 		Question = React.createClass({displayName: "Question",
 			render: function() {
 				...
 				var components = this.props.components.map(function(component,i){
 					return React.createElement(Component, {id: component.id, column: i, top: this.props.top+headingheight, height: this.props.height-headingheight, width: Math.ceil(this.props.width/this.props.components.length), left: i*this.props.width/this.props.components.length, component: component})
 				}.bind(this));
 		...
 		Component = React.createClass({displayName: "Component",
 			...
 			handleUpdate: function(item){
 				console.log("question " + this.props.id + " seen an update!");
 				console.log(item);
 			},
 			...
 			render: function(){
 				...
 				switch (this.props.component.type){
 					case "text":
 						formitem = React.createElement(TextInput, {width: this.props.width, id: this.props.component.id, height: this.props.height, value: this.props.component.value, handleUpdate: this.handleUpdate})
 						break;
 					case "options":
 						formitem = React.createElement(DropDown, {width: this.props.width, id: this.props.component.id, height: this.props.height, value: this.props.component.value, options: this.props.component.options || [], handleUpdate: this.handleUpdate})
 						break;
 					case "checkbox":
 						formitem = React.createElement(CheckBox, {width: this.props.width, height: this.props.height, text: this.props.component.text, value: this.props.component.value, id: this.props.component.id, selected: this.props.component.selected, handleUpdate: this.handleUpdate})
 						break;
 					case "radio":
 						formitem = React.createElement(Radios, {width: this.props.width, height: this.props.height, value: this.props.component.value, id: this.props.component.id, options: this.props.component.options || [], handleUpdate: this.handleUpdate})
 						break;
 					default:
 						break;
 				}
 		...
 		TextInput = React.createClass({displayName: "TextInput",
 			...
 			handleChange:function(event){
 				...
 				this.props.handleUpdate({id:this.props.id, name:event.target.value, value:event.target.value});
 			},
 		...
 		DropDown = React.createClass({displayName: "DropDown",
 			...
 			handleChange: function(event){
 				if (event.target.value != this.state.value){
 					...
 					this.props.handleUpdate({id:this.props.id, name:this.state.value, value:false});
 					this.setState({value:event.target.value});
 					this.props.handleUpdate({id:this.props.id, name:event.target.value, value:true});
 				}
 			},
 		...
 		Radios = React.createClass({displayName: "Radios",
			...
			handleSelect: function(item){
				if (item!=this.state.selected){
					this.props.handleUpdate({id:this.props.id, name:this.state.selected, value:false});
					this.setState({selected: item});	
					this.props.handleUpdate({id:this.props.id, name:item, value:true});
				}
			},
 		...
 		CheckBox = React.createClass({displayName: "CheckBox",
			...
			event: function(e){
				...
				this.props.handleUpdate({id:this.props.id, name:this.props.value, value:!this.state.selected});
			},
