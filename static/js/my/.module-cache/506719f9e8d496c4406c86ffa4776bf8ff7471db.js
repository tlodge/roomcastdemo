		...
		ModalAbout = React.createClass({displayName: "ModalAbout",
 		...
 		CheckBox = React.createClass({displayName: "CheckBox",
 			...
 			render:function(){
 				...
 				var top = (dim - this.props.height)/2;
 				var left = (dim - this.props.width)/2;
 				...
 				return 	React.createElement("label", {className: "checkbox-inline"}, 
 							React.createElement("div", {style: myStyle, id: this.props.id, value: this.props.value}, this.props.text)
 						)
 			}
 		})
	return {
