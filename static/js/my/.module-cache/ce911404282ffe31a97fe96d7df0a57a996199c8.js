		...
		ModalAbout = React.createClass({displayName: "ModalAbout",
 		...
 		ModalOptions = React.createClass({displayName: "ModalOptions",
			...
			render: function() {
				...
				var questions = this.props.options.map(function(option, i){
					return(
						React.createElement(Question, {top: i*this.props.height/this.props.options.length, height: this.props.height/this.props.options.length, width: this.props.width, question: option.question, components: option.components || []})
					)
				}.bind(this));
 		...
 		Question = React.createClass({displayName: "Question",
 			render: function() {
 				...
 				headingStyle={
 					fontSize: headingheight*0.8
 				}
 							
 				var components = this.props.components.map(function(component,i){
 					return React.createElement(Component, {top: this.props.top+headingheight, height: this.props.height-headingheight, width: this.props.width/this.props.components.length, left: i*this.props.width/this.props.components.length, data: component})
 				}.bind(this));
 				
 				return(
 					React.createElement("div", null, 
 						React.createElement("div", {style: myStyle}, React.createElement("h2", {style: headingStyle, className: "optionsquestion"}, this.props.question)), 
