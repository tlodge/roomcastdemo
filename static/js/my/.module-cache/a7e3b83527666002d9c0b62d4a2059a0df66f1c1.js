define(['jquery','react', 'mixins', 'modal'], function($, React, mixins, modal){
	...
	var MainPanel = React.createClass({displayName: "MainPanel",
		...
		handleButtonSelected: function(button){
		...
		render: function(){
			...
			return (
				React.createElement("div", {className: "buttonpanel"}, 
					React.createElement(ButtonLine, {colours: colours, buttons: this.state.buttons, buttonwidth: this.state.buttonwidth, windowheight: this.state.windowheight})
				)
			)
		}
	});
