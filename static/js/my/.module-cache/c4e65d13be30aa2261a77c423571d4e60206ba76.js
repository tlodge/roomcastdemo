		...
		render: function(){
			...
			var column = this.props.buttons.map(function(item, i){
				...
				var buttonStyle = {
					...
					'line-height':  this.props.buttonheight + "px",
				};
				
				return (
					 React.createElement(Button, {buttonstyle: buttonStyle, category: this.props.category, data: item, onClick: this.handleClick})
				);
			}.bind(this));
