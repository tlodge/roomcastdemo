		...
		render: function(){
			...
			return(
				React.createElement("div", null, 
					...
					React.createElement(modal.Modal, {ref: "modal", show: false, header: "Example Modal", buttons: buttons, handleShow: this.handleLog.bind(this, 'Modal about to show', 'info'), 
