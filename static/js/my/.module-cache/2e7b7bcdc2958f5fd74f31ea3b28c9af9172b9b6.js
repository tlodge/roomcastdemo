		...
		Modal = React.createClass({displayName: "Modal",
			...
			render: function() {
				...
				var buttons = this.props.buttons.map(function(button) {
					return React.createElement("button", {type: "button", className: "btn btn-" + button.type, onTouchStart: this.handleTouch.bind(this, button.handler), onClick: this.handleClick.bind(this, button.handler)}, button.text)
				}.bind(this))
