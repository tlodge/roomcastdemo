	...
	var 
						...
						React.createElement("div", {className: "modal-dialog", style: modalStyle}, 
							React.createElement("div", {className: "modal-content"}, 
								...
								React.createElement("div", {className: "modal-body", style: bodyStyle}, 
									React.createElement(ModalAbout, {width: Math.ceil(this.props.modalwidth*1/4), info: this.props.button.info}), 
									React.createElement(ModalOptions, {height: this.props.modalheight, left: Math.ceil(this.props.modalwidth*1/4), width: Math.ceil(this.props.modalwidth*3/4)})
								), 
		...
		ModalAbout = React.createClass({displayName: "ModalAbout",
 			render: function() {
 				...
 				return (React.createElement("div", {style: myStyle, dangerouslySetInnerHTML: {__html: this.props.info}}))
 			}
 		}),
 		...
 		ModalOptions = React.createClass({displayName: "ModalOptions",
			...
			render: function() {
 				...
 				return (React.createElement("div", {style: myStyle}, "hello!"))
 			}
 		})
