 		...
 		Component = React.createClass({displayName: "Component",
 			...
 			render: function(){
 				...
 				switch (this.props.component.type){
 					case "options":
 						formitem = React.createElement(DropDown, {width: this.props.width, height: this.props.height, options: this.props.component.options || [], handleUpdate: this.handleUpdate})
 						break;
 					case "checkbox":
