define(['jquery','react', 'mixins', 'modal'], function($, React, mixins, modal){
	...
	var MainPanel = React.createClass({displayName: "MainPanel",
		...
		getInitialState: function(){
			return {buttons:[], buttonwidth:0, windowheight:0, currentbutton:{}};
		},
		...
		render: function(){
			...
			return (
				React.createElement("div", {className: "buttonpanel"}, 
					React.createElement(ButtonList, {currentbutton: this.state.currentbutton, colours: colours, buttons: this.state.buttons, buttonwidth: this.state.buttonwidth, windowheight: this.state.windowheight})
				)
			)
		}
	});
			...
			return(	
				React.createElement("div", null, 
					...
					React.createElement(modal.Modal, {ref: "modal", show: false, header: "Example Modal", buttons: buttons}, 
						...
						React.createElement("p", null, this.props.currentbutton.name)
					)
				)
			)
