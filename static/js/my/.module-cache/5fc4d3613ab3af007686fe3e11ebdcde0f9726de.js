		...
		ModalAbout = React.createClass({displayName: "ModalAbout",
 		...
 		Radios = React.createClass({displayName: "Radios",
			...
			handleSelect: function(item){
 			...
 			render:function(){
 				...
 				var dim  = Math.min(width * 0.6, this.props.height * 0.6);
 				...
 				var options = this.props.options.map(function(option, i){
 					...
 					return React.createElement(Radio, {textStyle: radioText, radioStyle: radioStyle, value: option, handleSelect: this.handleSelect})
 				}.bind(this));
 		...
 		Radio = React.createClass({displayName: "Radio",
			...
			event: function(e){
 			...
 			render:function(){
 				return	React.createElement("div", {style: this.props.radioStyle, onTouchStart: this.handleTouch, onClick: this.handleClick})
 			}
