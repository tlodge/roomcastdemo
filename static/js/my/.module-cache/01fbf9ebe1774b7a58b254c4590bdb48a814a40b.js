		...
		render: function(){
			...
			return(	
				React.createElement("div", null, 
					...
					React.createElement(modal.Modal, {ref: "modal", modalwidth: this.props.windowwidth, modalheight: this.props.windowheight*0.8, show: false, header: this.state.currentbutton.name, buttons: buttons}, 
