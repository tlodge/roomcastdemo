define(['jquery','react', 'mixins', 'modal'], function($, React, mixins, modal){
	...
	var ButtonList = React.createClass({displayName: "ButtonList",
		...
		render: function(){
			...
			console.log("widnow width is ");
			console.log(this.props.windowwidth);
			return(	
				React.createElement("div", null, 
					React.createElement("div", {className: "buttoncolumns"}, columns), 
					React.createElement(modal.Modal, {ref: "modal", modalwidth: this.props.windowwidth, show: false, header: this.state.currentbutton.name, buttons: buttons}, 
