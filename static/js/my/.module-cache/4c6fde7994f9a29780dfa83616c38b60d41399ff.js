define(['jquery','react', 'bootstrap'], function($, React, bootstrap){
	var 
		...
		ModalButton = React.createClass({displayName: "ModalButton",
			...
			render: function() {
				return(
					React.createElement("button", {type: "button", className: "btn btn-" + this.props.type, onTouchStart: this.handleTouch, onClick: this.handleClick}, this.props.text)
		...
		Modal = React.createClass({displayName: "Modal",
			...
			render: function() {
				...
				var buttons = this.props.buttons.map(function(button) {
					return React.createElement("button", {type: "button", className: "btn btn-" + button.type, onClickCapture: button.handler}, button.text)
				})
