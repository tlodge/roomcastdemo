	...
	var ButtonList = React.createClass({displayName: "ButtonList",
		...
		render: function(){
			...
			var columns = this.props.buttons.map(function(item, i){
				...
				return (
					 React.createElement(ButtonColumn, {buttoncount: buttoncount-items.button.length, colours: this.props.colours, clickhandler: this.handleModalClick, column: i, left: left, buttonwidth: this.props.buttonwidth, buttonheight: this.props.buttonheight, category: item.category, buttons: item.buttons})
				);
	...
	var ButtonColumn = React.createClass({displayName: "ButtonColumn",
		...
		render: function(){
			...
			var column = this.props.buttons.map(function(item, i){
				...
				console.log(this.props.buttoncount + i);
				//var cindex = this.props.colours.length % (i*this.props.column);
