	...
	var 
		...
		modalmixin = function() {
			...
			return {
					...
					componentWillUnmount: function() {
						...
						console.log("component will unmoiunt!");
		...
		Modal = React.createClass({displayName: "Modal",
			...
			render: function() {
				...
				console.log("modal width is " );
				console.log(this.props.modalwidth);
				...
				var buttons = this.props.buttons.map(function(button) {
 				...
 				console.log("modal heogjyt is" );
 				console.log(this.props.modalheight);
 				...
 				var bodyStyle={
 					minHeight: this.props.modalheight + "px"
 				}
