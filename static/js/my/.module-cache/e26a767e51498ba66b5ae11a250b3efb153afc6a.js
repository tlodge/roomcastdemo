 		...
 		Component = React.createClass({displayName: "Component",
 			...
 			render: function(){
 				...
 				switch (this.props.component.type){
 					case "options":
 						component = React.createElement(DropDown, {width: this.props.width, options: this.props.component.options})
 						break;
 					default:
 						break;
 				}
 				
 				return React.createElement("div", {style: myStyle}, component)
